...
const Menusublink = document.querySelector("#sulka");
if (Menusublink) {
    const menuBody = document.querySelector('.menu__body');
...
//  Тач: Выкл меню влево при нажатии на ссылку 2
const Menusublink2 = document.querySelector("#sulka2");
if (Menusublink2) {
    const menuBody = document.querySelector('.menu__body');
    Menusublink2.addEventListener("click", function(e) {
        document.body.classList.toggle('_lock');
        iconMenu.classList.toggle('_active');
        menuBody.classList.toggle('_active');
    });
